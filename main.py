...
class SpriteKind:
    ...
    Сундук = SpriteKind.create()

def on_on_overlap(sprite, otherSprite):
    info.change_score_by(1)
    Coins.set_position(randint(5, 147), randint(7, 104))
...
Player1 = sprites.create(img("""
        ...
        . . f f e 2 1 2 1 2 1 e e f . .
        . . f e 1 f f f f f f 2 e f . .
...
animation.run_image_animation(Coins,
    ...
    500,
    True)
music.play(pianoRoll.create_song(hex("""
        0078000408020100001c0001dc00690000045e01000400000000000000000000056400010400082a0004000800010c04000800010b1000140001111400180001151c00200001093400380001113c0040000110
        """)),
